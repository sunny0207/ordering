...
<link rel="stylesheet" type="text/css" href="http://ec2-18-188-27-184.us-east-2.compute.amazonaws.com:8080/sso/common.css"></link>
<div>
	<div id="header" style="height:18%;width:100%">
		<jsp:include page="http://ec2-18-188-27-184.us-east-2.compute.amazonaws.com:8080/sso/header.jsp" />
	</div>
...
<div>
	<div id="header" style="height:18%;width:100%">
		...
		<div id="body" style="height:77%;width:100%;overflow:scroll;">
			<body>
					...
					<div class="tab" style="display:block height:77%width:100%" align="center">
	...
	<div id="footer"  style="height:5%;width:100%">
		<jsp:include page="http://ec2-18-188-27-184.us-east-2.compute.amazonaws.com:8080/sso/footer.jsp" />
	</div>
</div> 